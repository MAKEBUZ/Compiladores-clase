...
def serializedATN():
    return [
        ...
        0,0,0,21,19,1,0,0,0,22,23,5,2,0,0,23,30,3,4,2,0,24,25,5,5,0,0,25,
        26,3,0,0,0,26,27,5,6,0,0,27,30,1,0,0,0,28,30,5,7,0,0,29,22,1,0,0,
        0,29,24,1,0,0,0,29,28,1,0,0,0,30,5,1,0,0,0,3,11,19,29
    ]
...
class Expr3Parser ( Parser ):
    ...
    class FactorContext(ParserRuleContext):
        ...
        def factor(self):
            return self.getTypedRuleContext(Expr3Parser.FactorContext,0)
